...
class UsersController {
    ...
    async update(request, response) {
        ...
        if (!user) {
            throw new AppError("Erro: Tente novamente! Usuário não encontrado");
        }
        ...
        if (password && !old_password) {
            throw new AppError("Erro: Você precisa informar a senha antiga para definir a nova senha");
        }
        ...
        if (password && old_password) {
            ...
            if (!checkOldPassword) {
                throw new AppError("Erro: A senha anterior está errada!");
            }
